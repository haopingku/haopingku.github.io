!function(){/*
 ...
 limitations under the License.
*/
var google_code_prettify_css = "/stylesheet/google-code-prettify.min.css";
...
g=null)};g.type="text/javascript";g.src="";O.insertBefore(g,O.firstChild)})(H[q]);for(var T=H.length,F=[],q=0,B=Q.length;q<B;++q)F.push("");F.push(google_code_prettify_css);(function(g){function k(q){if(q!==z){var t=A.createElement("link");t.rel="stylesheet";t.type=
